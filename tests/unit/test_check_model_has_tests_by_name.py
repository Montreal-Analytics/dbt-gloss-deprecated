...
TESTS = (
    (["aa/bb/with_test1.sql",'--is_test'], ["--tests", "unique=1", "data=1"], True, 0),
    (["aa/bb/with_test1.sql",'--is_test'], ["--tests", "unique=1"], True, 0),
    (["aa/bb/with_test1.sql",'--is_test'], ["--tests", "unique=2"], True, 1),
    (["aa/bb/with_test1.sql",'--is_test'], ["--tests", "data=1"], True, 0),
    (["aa/bb/with_test2.sql",'--is_test'], ["--tests", "data=1"], True, 1),
    (["aa/bb/with_test2.sql",'--is_test'], ["--tests", "unique=1"], True, 0),
    (["aa/bb/with_test1.sql",'--is_test'], ["--tests", "unique=1", "data=1"], False, 1),
)
